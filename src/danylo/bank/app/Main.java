...
//        BronzeCustomer bz = new BronzeCustomer("Nikita", 1, 10000.0);
//        BronzeCustomer bz2 = new BronzeCustomer("Danilo", 2, 100000.0);
//        JuniorBanker jb = new JuniorBanker("Danilo", "junior", 1);
...
//
//        bz.topUpBalance(100.0, jb);
//        bz2.topUpBalance(100.0,jb);
//
//        System.out.println(bz.getBalance());
//        System.out.println(bz2.getBalance());
//        System.out.println(DaniloBank.getTotalBankAccount());
//
//        bz.withdrawMoney(233.0, jb);
//        bz2.withdrawMoney(56.0, jb);
//
//        System.out.println(bz.getBalance());
//        System.out.println(bz2.getBalance());
//        System.out.println(DaniloBank.getTotalBankAccount());
